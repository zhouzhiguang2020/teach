...
public class DateUtils {
     ...
     * @return 失败返回-1 ，所以尽量是datetime1大于datetime2
     */
    public static long compareDateSecond4(String datetime1, String datetime2) {
        try {
    ...
    //endDate='2020-12-11 00:00:00' 得到月日
    public static String DateString16formatString(String s) {
        String str = "";
        try {
            SimpleDateFormat sdf1 = new SimpleDateFormat("MM/dd");
            SimpleDateFormat sd = sdf;
            Date date = sd.parse(s);
    ...
    //endDate='2020-12-11 00:00:00' 得到时分
    public static String DateString17formatString(String s) {
        String str = "";
        try {
    ...
    //endDate='2020-12-11 00:00:00' 得到时分
    public static String DateString18formatString(String s) {
        String str = "";
        try {
    ...
    //endDate='2020-12-11 00:00:00' 得到时分
    public static String DateString21formatString(String s) {
        String str = "";
        try {
    ...
    //endDate='2020-12-11 00:00:00' 得到时分
    public static String DateString19formatString(String s) {
        String str = "";
        try {
     ...
     * @return
     */
    public static String DateString20formatString(String s) {
        String str = "";
        try {
     ...
     *
     */
    public static boolean isEquality(String str1, String str2) {
