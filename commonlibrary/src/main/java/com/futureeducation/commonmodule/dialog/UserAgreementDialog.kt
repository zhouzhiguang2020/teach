...
/**
 * Created by UserAgreementDialog.
 * User: ASUS
 * Date: 2019/12/10
 * Time: 20:56
 * 用户须知
 */
class UserAgreementDialog : AppCompatDialogFragment(), View.OnClickListener {
...
//        AutoSize.autoConvertDensity(activity, 360f, true)
    ...
    private fun initdate() {
        //访问
        mWVmhtml!!.loadUrl("https://ap20.ytwljy.com/html/app.html")
