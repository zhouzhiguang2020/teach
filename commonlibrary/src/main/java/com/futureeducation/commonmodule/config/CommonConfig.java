...
public class CommonConfig {
    ...
    private CommonConfig() {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
            ...
            cachePath = CommonApplication.Companion.getContext().getCacheDir().getPath();
        }
        this.PATH_APP_CACHE = cachePath + File.separator + "Cache";
        this.PATH_APP_ROOT = FileUtils.getAppRootPath(CommonApplication.Companion.getInstance()).getAbsolutePath() + File.separator + "FEG" + File.separator + "snapshot";
