 ...
 * Time: 10:48
 */
class BingSuccessDialog : DialogFragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(
            com.futureeducation.commonmodule.R.layout.grace_dialog_layout,
            null
        )
        val massage = view.findViewById<TextView>(com.futureeducation.commonmodule.R.id.msg)
        ...
        val confirm: CommonShapeButton = view.findViewById(com.futureeducation.commonmodule.R.id.confirm)
