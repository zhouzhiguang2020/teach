...
import com.future_education.homework.fragment.LearningConditionFragment
 ...
 * 老师作业组件
 */
class LearningConditionComponent : IComponent {
    private var context: Context? = null

    override fun getName(): String {
        return CompocomponentName.LEARNINGCONDITION_COMPINENR
    }
    ...
    override fun onCall(cc: CC?): Boolean {
        ...
        when (actionName) {
            ...
            CompocomponentName.LEARNINGCONDITION_FRAGMENT -> {
                //调用的是获取主fragment
                var fragment = LearningConditionFragment()
