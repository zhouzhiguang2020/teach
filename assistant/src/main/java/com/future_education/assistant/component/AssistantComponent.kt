...
import com.future_education.homework.fragment.AssistantFragment
 ...
 * 老师作业组件
 */
class AssistantComponent : IComponent {
    private var context: Context? = null

    override fun getName(): String {
        return CompocomponentName.ASSISTANT_COMPINENR
    }
    ...
    override fun onCall(cc: CC?): Boolean {
        ...
        when (actionName) {
            ...
            CompocomponentName.ASSISTANT_FRAGMENT -> {
                //调用的是获取主fragment
                var fragment = AssistantFragment()
