 ...
 * 学生管理选择班级对话框
 */
class SelectClassCourseDialog : AppCompatDialogFragment(),View.OnClickListener  {
    ...
    private var listener: OnSelectClassCurseOptionListener? = null
...
//        } as MutableList<TeacherClassBean>
    ...
    fun setOnSelectCoursesOptionListener(listener: OnSelectClassCurseOptionListener) {
